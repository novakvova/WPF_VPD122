...
string inputFile = @"C:\Users\novak\Desktop\images\WebP\template2.webp";
...
try
{
    ...
    //{
    //FileStream fs = new FileStream(inputFile, FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
    //var img = System.Drawing.Image.FromStream(fs); //System.Drawing.Image.FromStream(stream);
    //Bitmap bmp = new Bitmap(img);

    string outputFile = "outfile.jpg";
    FileStream fs = new FileStream(inputFile, FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
    using (FileStream webPFileStream = new FileStream(outputFile, FileMode.Create))
    {
...
//{
//    string outputFile = "C:\\Users\\novak\\Desktop\\images\\WebP\\template2.jpg";
